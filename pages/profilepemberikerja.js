...
export default function profilepemberikerja() {
    ...
    // const handleSave = () => {
    //     alert("Data Berhasil Disimpan oke");
    //     return setMode(true);
    // };
    ...
    async function GetCountry() {
        console.log("kesini");
        await fetch('http://devsitaracore.tapera.go.id/api/tapera_employers/Employers/GetEmployerById',
            {
                method: 'POST',
                body: JSON.stringify({
                    "id": "3d0e6a7d-3f6a-49e1-8541-fa8e4b839a02"
                }),
            })
            .then((r) => {
            ...
            .then((data) => {
                setCountryData(data);
                initialValues.namaInstansiPemberiKerja = data.institution;
                initialValues.jumlahPekerja = data.total_employee;
                initialValues.nomorIdentitasPemberiKerja = data.identity_number;
                initialValues.skalaUsaha = data.state_official;
                initialValues.alamatEmail = data.email_address;
                initialValues.noTelp = data.phone_number;
                initialValues.npwp = data.npwp;
                initialValues.statusInstansiPemberiKerja = data.employer_type;
                initialValues.alamatDomisili = data.employer_address[0]["address"];
                initialValues.kodePosDomisili = data.employer_address[0]["postal_code"];
                initialValues.namaPenanggungJawab1 = data.employer_representative[0]["name"];
                initialValues.jabatanPenanggungJawab1 = data.employer_representative[0]["department"];
                initialValues.noSelulerPenanggungJawab1 = data.employer_representative[0]["celluler_number"];
                initialValues.alamatEmailPenanggungJawab1 = data.employer_representative[0]["email_address"];
                initialValues.noTelpPenanggungJawab1 = data.employer_representative[0]["phone_number"];
            })
    }
            ...
            <div style={{ backgroundColor: 'white' }}>
                ...
                >
                    <Grid container item spacing={0} xs={1} sm={1} md={1} direction="column">
                        ...
                        <Grid item> <Typography align="center">{countryData.name}</Typography></Grid>
                    ...
                    <Grid container item spacing={2} xs={7} sm={7} md={7}>
                        <Formik
                            ...
                            onSubmit={values => {
                                 ...
                                 fetch('http://devsitaracore.tapera.go.id/api/tapera_employers/Employers/UpdateEmployer',
                                    {
                                        method: 'POST',
                                        body: JSON.stringify({ "employer": { "id": countryData.id}, "changes": { "institution": values.namaInstansiPemberiKerja, "employer_type": 2, "state_official": 1, "total_employee": "4555", "npwp": "252525111414544", "phone_number": "081324245552", "email_address": "cdcd@ahhh.cc", "employer_address": [{ "address": "kms", "city_code": "1103", "postal_code": "12555", "province_code": "19", "country_code": "CC", "address_type": 1 }], "employer_representative": [{ "name": "drake", "department": "1101", "phone_number": "1123123233", "celluler_number": "446666", "email_address": "ehe@er.sas" }] } }),
                                    })
                                    .then((r) => {
                                    ...
                                    .then((data) => {
                                        ...
                                        console.log("IDdata"+ countryData.id);
                                        console.log("NAMA" +values.namaInstansiPemberiKerja);
                                        setMode(true);
                                        alert("Berhasil Menyimpan Data ");
                            ...
                            >
                                ...
                                <Grid item xs={12} style={{backgroundColor:'#BDBDBD'}}>   <MyTypography className={classes.expand3}>Informasi Pemberi Kerja</MyTypography></Grid>
                                    ...
                                    <Field
                                        ...
                                        type="input"
                                        as={TextField} 
                                        defaultValue={initialValues.namaInstansiPemberiKerja}
                                        //values={initialValues.namaInstansiPemberiKerja}
                                    ...
                                    <TextField
                                        ...
                                        {...formik.getFieldProps('nomorIdentitasPemberiKerja')}
                                        disabled='true'
                                    >
                                    </TextField>
                                    ...
                                    <TextField
                                        ...
                                        //  defaultValue="Diisi oleh Tapera"
                                        {...formik.getFieldProps('tanggalDaftarPemberiKerja')}
                                        disabled='true'
                                    >
                                    </TextField>
                                    <TextField
                                    ...
                                    <Field
                                        ...
                                        name="skalaUsaha"
                                        defaultValue={initialValues.skalaUsaha}
                                        as={TextField}
                                    ...
                                    <Field
                                        ...
                                        name="jumlahPekerja"
                                        as={TextField}
                                        defaultValue={initialValues.jumlahPekerja}
                                        disabled={mode}
