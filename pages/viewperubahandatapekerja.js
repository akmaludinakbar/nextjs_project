...
import FormLihatdatapribadi from '../components/formLihatdatapribadi';
import FormLihatdataalamat from '../components/formLihatdataalamat';
import FormLihatdatapekerjaan from '../components/formLihatdatapekerjaan';
import FormLihatdatafinansial from '../components/formLihatdatafinansial';
...
export default function viewperubahandatapekerja() {
  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel value={valueP} index={1}>
        <FormLihatdatapribadi handleNext={handleChange} listdata= {listdataPekerja} handleEditNamaLengkap={handleEditNamaLengkap}></FormLihatdatapribadi>
      </TabPanel>
      <TabPanel value={valueP} index={2}>
      <FormLihatdataalamat handleNext={handleChange} listdata= {listdataPekerja}></FormLihatdataalamat>
      </TabPanel>
      <TabPanel value={valueP} index={3}>
       <FormLihatdatapekerjaan handleNext={handleChange} listdata= {listdataPekerja}></FormLihatdatapekerjaan>
      </TabPanel>
      <TabPanel value={valueP} index={4}>
        <FormLihatdatafinansial handleNext={handleChange} listdata= {listdataPekerja} editnamaLengkap={editnamaLengkap}></FormLihatdatafinansial>
      </TabPanel>
     </Layout>
    </div>
  );
}
viewperubahandatapekerja.Layout=Dashboard;