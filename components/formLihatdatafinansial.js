...
const TypographFinansial = styled(Typography)({
  fontStyle: 'normal',
  fontWeight: '600',
  lineHeight: '39px',
  color: '#008F4C'
...
const initialValues ={
  ...
  namaPemilikRekeningBankTujuanRedemption: 'Jerry Ni',
  kodeBankTujuanRedemption: '',
  namaBankTujuanRedemption:'PT Bank IBK Indonesia Tbk',
  cabangRekeningBankTujuanRedemption:'007',
  negaraKorespondensiBankTujuanRedemption:'CC',
  }
...
export default function formdatafinansial(props) {
    ...
    const handleOnClickSubmit = () => {
      ...
      Router.push('/inputperubahandatapekerja');
    }
    ...
    return (
      <form onSubmit={formik.handleSubmit} className={classes.root}>
        <TypographFinansial className={classes.judul32}>Informasi Rekening Bank</TypographFinansial>
      <div>
        <TextField
        ...
        <TextField
          ...
          helperText={formik.touched.kodeBankTujuanRedemption && formik.errors.kodeBankTujuanRedemption ? formik.errors.kodeBankTujuanRedemption : null}
          error={formik.touched.kodeBankTujuanRedemption && formik.errors.kodeBankTujuanRedemption?true:false}
          {... formik.getFieldProps('kodeBankTujuanRedemption')}
        ...
        <TextField
          ...
          value={formik.values.cabangRekeningBankTujuanRedemption}
          onChange={formik.handleChange}
         // onBlur={formik.handleBlur}
        >
        </TextField>
